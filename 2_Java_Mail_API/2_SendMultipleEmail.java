...
public class SendMultipleEmail {
    public static void main(String[] args) {
        ...
        try {
            ...
            //create a array to store multiple Recipient
            String[] recipient_email = {"pandeharshavardhan@gmail.com","harshavardhanpande99@gmail.com"};

            //set Multiple Recipient using setRecipient method and we separate address with ',' using String.join()
            mimeMessage.setRecipients(Message.RecipientType.TO, String.join(",",recipient_email));
